...
# Disable Redis for testing to avoid connection errors
...
def app():
    ...
    # Override some settings for smoke tests
    app.config.update({
        'TESTING': True,
...
class TestUserRoutes:
    ...
    def test_get_user(self, client, auth_headers): # Gvies error
...
class TestAppointmentRoutes:
    ...
    def test_get_available_slots(self, client): # error
...
class TestReportingRoutes:
    ...
    def test_get_hospital_statistics(self, client, auth_headers): # error
    ...
    def test_get_user_activity_report(self, client, auth_headers): # error
